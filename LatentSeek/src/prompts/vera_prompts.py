...
def get_vera_prompt(vera_name, question, pref_input, solution):
    '''
    Get prompt used for preference alignment verifications with automatic preference generation.
    Args:
        vera_name: str, name of the verifier.
        question: str, the original question asked.
        solution: str, the AI's response to be evaluated.
        preference: str, optional. The preference requirement. If None, will auto-generate based on question.
    '''
    # Auto-generate preference if not provided
    ...
    vera_names_to_prompts = {
        ...
        "preference_alignment": (
            ...
            "Preference: 'Your answer should be concise as much as possible.'\n"
            "AI Response: 'To bake a cake: mix ingredients, bake at 350°F for 30 minutes.'\n"
            f"Assessment: Response is very concise while providing key information.\n\n"
            "Example 2:\n"
            "Preference: 'Your answer should be verbose as much as possible.'\n"
            "AI Response: 'Use flour.'\n"
            f"Assessment: Response is too brief, not verbose as requested. \n\n"
        ),
