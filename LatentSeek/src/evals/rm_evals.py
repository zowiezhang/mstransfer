...
from prompts.prompts import PREFERENCE_PROMPTS, RESPONSE_PROMPT
from config import args


class RMScorer():

    def __init__(self, args, rm_batch_size = 8):
        self.args = args
    ...
    def batch_score(self, messages: List[List[Dict[str, str]]]) -> List[float]:
        ...
        batch_inputs = self.tokenizer(batch_input, 
                                 ...
                                 max_length = 2048, #max(2048, self.args.max_new_tokens), 
                                 return_tensors = "pt")
    ...
    def get_rm_eval(self, player_names_list):
        ...
        # players_list = [self.load_data('/home/shiweiye/zhaowei/LatentSeek/responses/optimized_answers.json')]
        # players_list = [self.load_data('/home/shiweiye/zhaowei/LatentSeek/responses/optimized_answers-10.json')]
        # players_list = [self.load_data('/home/shiweiye/zhaowei/LatentSeek/responses/original_answers.json')]
        # players_list = [self.load_data('/home/shiweiye/zhaowei/LatentSeek/responses/qwen_opad.json')]
        # players_list = [self.load_data('/home/shiweiye/zhaowei/LatentSeek/responses/amulet.json')]
        # players_list = [self.load_data('/home/shiweiye/zhaowei/LatentSeek/responses/la.json')]
        ...
        for player_idx, player in tqdm(enumerate(players_list)):
            ...
            for data_subset in tqdm(batch_datas):
                messages = [[
                    {"role": "user", "content": RESPONSE_PROMPT.format(question = data['question'], preference = "Your answer should be creative as much as possible.")},#data['question'] + ' ' + "Your answer should be as creative as possible."},#PREFERENCE_PROMPTS[data['preference']]},"Your answer should be as creative as possible."
